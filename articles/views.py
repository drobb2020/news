...
from django.views.generic import DetailView, FormView, ListView  # type: ignore
from django.views.generic.detail import SingleObjectMixin  # type: ignore
from django.views.generic.edit import CreateView, DeleteView, UpdateView  # type: ignore
